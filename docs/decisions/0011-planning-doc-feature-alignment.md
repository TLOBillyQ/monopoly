...
### D2 — 谢礼皮肤撤回，皮肤统一 198 金豆购买

2026-06-23 用户裁定删除原谢礼/赠礼/赞助皮肤功能。`features/v102/skin_shop.feature` 不再保留赠礼解锁、谢礼按钮、赠礼价格图标隐藏等契约。

所有皮肤按购买解锁，价格统一为 198 金豆。ADR 0010 随此裁定废止。
...
签到、分享任务、粉丝团权益、成就、排行榜依赖宿主账号、支付、社交、统计接口。本轮只做玩法与已接入 v102 UI 的 feature 对齐，不为这些模块写可执行 Gherkin。
