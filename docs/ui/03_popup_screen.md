...
显示与隐藏：
- 打开：`RuntimeUI.open_choice_modal`（`Manager/System/RuntimeUI.lua`）
- 关闭：`RuntimeUI.close_choice_modal`（`Manager/System/RuntimeUI.lua`）
...
显示与隐藏：
- 打开：`RuntimeUI.push_popup`（`Manager/System/RuntimeUI.lua`）
- 关闭：`RuntimeUI.close_popup`（`Manager/System/RuntimeUI.lua`）
