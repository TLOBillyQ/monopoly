...
require "game.rule.bankrupt"
require "game.rule.target"
require "game.rule.agent"
require "game.rule.win"
require "game.bootstrap"

local auto_runner = require("turn.auto")
local board_scene = require("visual.render.board")
...
local market_ui = require("visual.shop_layout")
...
local function _install_game_init(state)
  RegisterTriggerEvent({ EVENT.GAME_INIT }, function()
    require "lib.third_party.UIManager.Utils"
