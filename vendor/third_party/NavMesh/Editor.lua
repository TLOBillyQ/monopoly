...
local Mesh = require "vendor.third_party.NavMesh.Mesh"
local Node = require "vendor.third_party.NavMesh.Node"
local Utils = require "vendor.third_party.NavMesh.__init"
Editor.roles = {}
