(function () {
  ...
  function render_hero(data) {
    ...
    var generated = data.metadata && data.metadata.generated_at
    ...
    by_id("summary_text").textContent =
      "An editorial, boardroom-style view of engineering risk across src/, surfacing where complexity and observed test reach combine into the highest maintenance exposure.";
