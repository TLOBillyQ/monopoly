...
local function _usage()
  io.write("Usage:\n")
  io.write("  lua scripts/architecture/arch_view_cli.lua scan --out <file> [--project-root <dir>] [--config <file>]\n")
  io.write("  lua scripts/architecture/arch_view_cli.lua check [--project-root <dir>] [--config <file>]\n")
  io.write("  lua scripts/architecture/arch_view_cli.lua viewer --out-dir <dir> [--project-root <dir>] [--config <file>] [--in-json <file>] [--open]\n")
end
