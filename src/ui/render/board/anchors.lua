...
local function _render_board_tiles(board, tiles, tile_count)
  ...
  for i = 1, tile_count do
    ...
    local contiguous_rent = tile_state and tile_state.contiguous_rent or nil
...
--[[ mutate4lua-manifest
version=2
projectHash=5bcb5bf3e4aaf610
scope.0.id=chunk:src/ui/render/board/anchors.lua
scope.0.kind=chunk
scope.0.startLine=1
scope.0.endLine=107
scope.0.semanticHash=fb46d3ab7b4f7549
scope.1.id=function:M.ensure_tile_anchors:79
scope.1.kind=function
scope.1.startLine=79
scope.1.endLine=100
scope.1.semanticHash=a566f36b42a763ec
]]
