...
local function _register_default_handlers()
  ...
  registry.register("teleport_effect", function(state, anim, duration, opts)
    return handlers.play_teleport_effect(state, anim, duration, opts)
  end)
  registry.register("forced_relocation", function(state, anim, duration, opts)
    return handlers.play_forced_relocation(state, anim, duration, opts)
  end)
