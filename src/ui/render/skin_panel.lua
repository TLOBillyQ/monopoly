...
local function _refresh_price_icon(ui, slot, skin)
...
function skin_panel_view.refresh_slots(state, catalog, deps)
  ...
  for slot in ipairs(nodes.card_images) do
    ...
    _refresh_price_icon(ui, slot, skin)
...
--[[ mutate4lua-manifest
version=2
projectHash=cbf29ce484222325
scope.0.id=chunk:src/ui/render/skin_panel.lua
scope.0.kind=chunk
scope.0.startLine=1
scope.0.endLine=174
scope.0.semanticHash=3f37e31e1bbb3705
...
scope.10.semanticHash=49cb61b99511f255
]]
