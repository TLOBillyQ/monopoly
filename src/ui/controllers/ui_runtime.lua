...
local input_lock_policy = require("src.ui.input.input_lock_policy")
...
local state = require("src.ui.controllers.ui_state")
local assets = require("src.ui.render.ui_assets")
local item_slots = require("src.ui.controllers.item_slots")
local debug = require("src.ui.controllers.debug_view")
