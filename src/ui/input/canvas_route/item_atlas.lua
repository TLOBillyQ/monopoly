...
local function _append_slot_selects(specs, names)
...
function intents.build()
  ...
  _append_slot_selects(specs, nodes.slots)
  _append_slot_selects(specs, nodes.image_buttons)
  _append_slot_selects(specs, nodes.name_labels)
  return specs
end
