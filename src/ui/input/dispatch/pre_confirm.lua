...
scope.1.endLine=20
scope.1.semanticHash=755042207e7a0b17
scope.2.id=function:_can_local_owner_open_pre_confirm:22
scope.2.kind=function
scope.2.startLine=22
scope.2.endLine=29
scope.2.semanticHash=ddbceecd497f96f1
scope.3.id=function:_requires_choice_select_pre_confirm:31
scope.3.kind=function
scope.3.startLine=31
scope.3.endLine=39
scope.3.semanticHash=2d19a630177e3eaa
scope.4.id=function:pre_confirm_flow.needs_pre_confirm:41
scope.4.kind=function
scope.4.startLine=41
scope.4.endLine=56
scope.4.semanticHash=e91cc55e0681d490
scope.5.id=function:_resolve_enter_params:58
scope.5.kind=function
scope.5.startLine=58
scope.5.endLine=73
scope.5.semanticHash=56f11756ce2b3bb9
scope.6.id=function:pre_confirm_flow.enter:75
scope.6.kind=function
scope.6.startLine=75
scope.6.endLine=98
scope.6.semanticHash=7af127f5e7f4f304
scope.7.id=function:_restore_prior_screen:100
scope.7.kind=function
scope.7.startLine=100
scope.7.endLine=110
scope.7.semanticHash=54eb8b91416ad9dc
scope.8.id=function:pre_confirm_flow.cancel:112
scope.8.kind=function
scope.8.startLine=112
scope.8.endLine=123
scope.8.semanticHash=74e08744a52c05e4
]]
