...
--[[ mutate4lua-manifest
version=2
projectHash=debd4d59625dff40
scope.0.id=chunk:src/ui/view/init.lua
scope.0.kind=chunk
scope.0.startLine=1
scope.0.endLine=195
scope.0.semanticHash=ce94b51376ab83db
...
scope.3.endLine=49
scope.3.semanticHash=9745df46089ec8fa
scope.4.id=function:_fill_meta:51
scope.4.kind=function
scope.4.startLine=51
scope.4.endLine=62
scope.4.semanticHash=6a333254ef2dcd71
scope.5.id=function:_should_update_board:64
scope.5.kind=function
scope.5.startLine=64
scope.5.endLine=66
scope.5.semanticHash=3be0e162291fd81d
scope.6.id=function:_should_update_auto_labels:68
scope.6.kind=function
scope.6.startLine=68
scope.6.endLine=70
scope.6.semanticHash=0d56ea82e43c2f10
scope.7.id=function:_build_panel_flags:74
scope.7.kind=function
scope.7.startLine=74
scope.7.endLine=79
scope.7.semanticHash=ecb84982f98789aa
scope.8.id=function:_should_update_slots:81
scope.8.kind=function
scope.8.startLine=81
scope.8.endLine=86
scope.8.semanticHash=636b59a88be825ca
scope.9.id=function:_should_refresh_choice:88
scope.9.kind=function
scope.9.startLine=88
scope.9.endLine=90
scope.9.semanticHash=782f4e20e2c854a6
scope.10.id=function:model_api.build:92
scope.10.kind=function
scope.10.startLine=92
scope.10.endLine=119
scope.10.semanticHash=c23757569c1d0ad2
scope.11.id=function:_resolve_update_ctx:121
scope.11.kind=function
scope.11.startLine=121
scope.11.endLine=126
scope.11.semanticHash=489c2b7da7ea1536
scope.12.id=function:_update_item_slots_model:128
scope.12.kind=function
scope.12.startLine=128
scope.12.endLine=133
scope.12.semanticHash=f5ef382ad8ea6e05
scope.13.id=function:_update_choice_market:135
scope.13.kind=function
scope.13.startLine=135
scope.13.endLine=144
scope.13.semanticHash=24576202b7d632b5
scope.14.id=function:_update_player_meta_model:146
scope.14.kind=function
scope.14.startLine=146
scope.14.endLine=153
scope.14.semanticHash=61d20646bcb5d5f1
scope.15.id=function:model_api.update:155
scope.15.kind=function
scope.15.startLine=155
scope.15.endLine=192
scope.15.semanticHash=1d833191e79e8fb3
]]
