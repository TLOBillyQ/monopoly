local board_runtime = require("src.presentation.render.board_runtime")
...
function pipeline.render(state_ctx, ui_model, log_once, build_log_prefix, opts)
  ...
  local runtime = opts and opts.runtime or require("src.presentation.adapter.ui_runtime_port")
