...
local ui_event_bindings = require("src.presentation.interaction.ui_event_bindings")
local ui_intent_dispatcher = require("src.presentation.interaction.ui_intent_dispatcher")
local canvas_registry = require("src.presentation.canvas_runtime.canvas_registry")
