...
local camera_sync = require("src.presentation.adapter.presentation_ports.ui_sync.CameraSync")
local ui_gate_sync = require("src.presentation.adapter.presentation_ports.ui_sync.UIGateSync")
