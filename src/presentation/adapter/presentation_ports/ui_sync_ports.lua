...
local camera_sync = require("src.presentation.adapter.presentation_ports.ui_sync.camera_sync")
local ui_gate_sync = require("src.presentation.adapter.presentation_ports.ui_sync.ui_gate_sync")
