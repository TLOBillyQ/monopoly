...
local render_pipeline = require("src.presentation.canvas_runtime.canvas_render_pipeline")
local input_lock_policy = require("src.presentation.interaction.ui_input_lock_policy")
...
local state = require("src.presentation.adapter.ui_view_service.state")
local assets = require("src.presentation.adapter.ui_view_service.assets")
local item_slots = require("src.presentation.adapter.ui_view_service.item_slots")
local debug = require("src.presentation.adapter.ui_view_service.debug")
