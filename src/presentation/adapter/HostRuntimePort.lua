...
local role_resolver = require("src.presentation.adapter.host_runtime.RoleResolver")
local unit_lifecycle = require("src.presentation.adapter.host_runtime.UnitLifecycle")
local scene_ui = require("src.presentation.adapter.host_runtime.SceneUI")
local raycast = require("src.presentation.adapter.host_runtime.Raycast")
local sfx_runtime = require("src.presentation.adapter.host_runtime.SfxRuntime")
