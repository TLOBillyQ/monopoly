local board_slice = require("src.presentation.state" .. ".ui_model.board_slice")
local item_slice = require("src.presentation.state" .. ".ui_model.item_slice")
local choice_slice = require("src.presentation.state" .. ".ui_model.choice_slice")
local panel_slice = require("src.presentation.state" .. ".ui_model.panel_slice")
