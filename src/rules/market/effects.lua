...
--[[ mutate4lua-manifest
version=2
projectHash=7f8d3ce055520f68
scope.0.id=chunk:src/rules/market/effects.lua
scope.0.kind=chunk
scope.0.startLine=1
scope.0.endLine=47
scope.0.semanticHash=d74f5d59a4b3a38c
...
scope.2.endLine=36
scope.2.semanticHash=3cabb5a5b1fab3db
scope.3.id=function:module.register_effect_executors:40
