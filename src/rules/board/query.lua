...
--[[ mutate4lua-manifest
version=2
projectHash=5f060b077d9705cf
scope.0.id=chunk:src/rules/board/query.lua
scope.0.kind=chunk
scope.0.startLine=1
scope.0.endLine=235
scope.0.semanticHash=f200c445a96454a8
...
scope.6.id=function:_sign_direction:100
scope.6.kind=function
scope.6.startLine=100
scope.6.endLine=102
scope.6.semanticHash=f62be3aa5b47b3f7
scope.7.id=function:_direction_from_geometry:104
scope.7.kind=function
scope.7.startLine=104
scope.7.endLine=113
scope.7.semanticHash=9956b328c6074c62
scope.8.id=function:_classify_by_direction:115
scope.8.kind=function
scope.8.startLine=115
scope.8.endLine=121
scope.8.semanticHash=acfa1d0f62f1ce03
scope.9.id=function:_center_out_order:181
scope.9.kind=function
scope.9.startLine=181
scope.9.endLine=200
scope.9.semanticHash=fcfbc1b12a68afab
]]
