...
--[[ mutate4lua-manifest
version=2
projectHash=8c9e480e1a810c8b
scope.0.id=chunk:src/turn/optional_action_completion.lua
scope.0.kind=chunk
scope.0.startLine=1
scope.0.endLine=147
scope.0.semanticHash=2550881f9fd0e85a
...
scope.15.endLine=132
scope.15.semanticHash=3fcf6738a61e7eac
scope.16.id=function:optional_action_completion.complete_optional_action_phase:134
