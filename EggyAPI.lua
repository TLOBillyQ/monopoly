...
---事件主体 Default 多类型
--[[
LuaAPI.global_register_trigger_event({EVENT.LUA_ON_DISABLE, }, function(event_name, actor, data)
end)
--]]
EVENT.LUA_ON_DISABLE = "LUA_ON_DISABLE"

---生物创建
---事件主体 Global 全局触发器
--[[
LuaAPI.global_register_trigger_event({EVENT.LUA_ON_EGGYUNIT_ADDED, }, function(event_name, actor, data)
end)
--]]
EVENT.LUA_ON_EGGYUNIT_ADDED = "LUA_ON_EGGYUNIT_ADDED"

---生物销毁
---事件主体 Global 全局触发器
--[[
LuaAPI.global_register_trigger_event({EVENT.LUA_ON_EGGYUNIT_REMOVING, }, function(event_name, actor, data)
end)
--]]
EVENT.LUA_ON_EGGYUNIT_REMOVING = "LUA_ON_EGGYUNIT_REMOVING"

---当组件启用
---事件主体 Default 多类型
--[[
LuaAPI.global_register_trigger_event({EVENT.LUA_ON_ENABLE, }, function(event_name, actor, data)
end)
--]]
EVENT.LUA_ON_ENABLE = "LUA_ON_ENABLE"

---每帧
---事件主体 Default 多类型
--[[
LuaAPI.global_register_trigger_event({EVENT.LUA_TICK, }, function(event_name, actor, data)
end)
--]]
EVENT.LUA_TICK = "LUA_TICK"
