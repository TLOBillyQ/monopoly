...
describe("presentation_target_pick", function()
  it("_test_target_screen_uses_labels_only_and_hides_projection_with_slots", function()
  ...
  it("_test_target_screen_hides_unused_slots_when_unique_options_less_than_seven", function()
    local state, nodes, query_nodes = _build_choice_modal_state()
    local choice = {
      id = 89,
      kind = "roadblock_target",
  ...
  it("_test_target_confirm_dispatches_selected_option", function()
    ...
    _with_target_pick_runtime(env, function()
      ...
      env.nodes["位置-槽位2按钮"]._listener_cb({})
      _assert_eq(#env.state.turn_action_port.dispatched, 1, "slot tap should dispatch one action")
      _assert_eq(env.state.turn_action_port.dispatched[1].type, "choice_select", "slot tap should dispatch choice_select")
      _assert_eq(env.state.turn_action_port.dispatched[1].option_id, 102, "slot tap should dispatch the slot option")
    end)
  end)

  it("_test_target_pick_tick_updates_selection_on_hit_change", function()
    local env = _build_target_pick_env()
  ...
  it("_test_target_pick_tick_ignores_non_candidate", function()
    local env = _build_target_pick_env()
    _with_target_pick_runtime(env, function(runtime)
      target_choice_effects.enter(env.state, env.choice)
  ...
  it("_test_target_pick_scene_click_locks_target_and_pauses_raycast", function()
    local env = _build_target_pick_env()
    _with_target_pick_runtime(env, function(runtime)
      target_choice_effects.enter(env.state, env.choice)
  ...
  it("_test_target_pick_confirm_button_is_inert", function()
    local env = _build_target_pick_env()
    _with_target_pick_runtime(env, function()
      canvas_event_router.bind(env.state, function()
        return env.game
      ...
      _assert_eq(#env.state.turn_action_port.dispatched, 0, "confirm button must not dispatch without lock")
      target_choice_effects.on_scene_pick(env.state, 101, 1, {})
      env.nodes["位置_确认按钮"]._listener_cb({})
      _assert_eq(#env.state.turn_action_port.dispatched, 0, "confirm button must remain inert even after scene pick")
      _assert_eq(env.nodes["位置_确认按钮"].visible, false, "confirm button must stay hidden")
      _assert_eq(env.nodes["位置_确认按钮"].disabled, true, "confirm button must stay disabled")
    end)
  end)

  it("_test_target_pick_cancel_button_is_inert", function()
    local env = _build_target_pick_env()
    _with_target_pick_runtime(env, function()
      canvas_event_router.bind(env.state, function()
        return env.game
      ...
      target_choice_effects.enter(env.state, env.choice)
      target_choice_effects.on_scene_pick(env.state, 103, 1, {})
      _assert_eq(env.nodes["位置_确认按钮"].visible, false, "confirm button must stay hidden after lock")
      _assert_eq(env.nodes["位置_取消按钮"].visible, false, "cancel button must stay hidden after lock")
      _assert_eq(env.nodes["位置_确认按钮"].text, "", "confirm button must keep empty label")
      _assert_eq(env.nodes["位置_取消按钮"].text, "", "cancel button must keep empty label")
      env.nodes["位置_取消按钮"]._listener_cb({})
      _assert_eq(env.state.target_choice_runtime.locked_option_id, 103, "cancel listener must not clear lock")
      _assert_eq(#env.state.turn_action_port.dispatched, 0, "cancel listener must not dispatch")
    end)
  end)

  it("_test_target_pick_leave_hides_scene_units", function()
    local env = _build_target_pick_env()
    _with_target_pick_runtime(env, function(runtime)
      target_choice_effects.enter(env.state, env.choice)
  ...
  it("_test_target_pick_enter_spawns_candidate_markers_at_height_1_6", function()
    local env = _build_target_pick_env()
  ...
  it("_test_target_pick_degrades_without_raycast_api", function()
    local env = _build_target_pick_env()
    _with_target_pick_runtime(env, function()
      canvas_event_router.bind(env.state, function()
        return env.game
      ...
      _with_patches({
        ...
        target_choice_effects.step(env.game, env.state, 0.1)
        env.nodes["位置-槽位2按钮"]._listener_cb({})
        _assert_eq(#env.state.turn_action_port.dispatched, 1, "slot tap should still work when raycast unavailable")
        _assert_eq(env.state.turn_action_port.dispatched[1].option_id, 102, "slot tap should dispatch the slot option")
      end)
    end)
  end)

  it("_test_target_pick_scene_click_resolves_option_from_payload_unit", function()
    local env = _build_target_pick_env()
    _with_target_pick_runtime(env, function()
      target_choice_effects.enter(env.state, env.choice)
  ...
  it("_test_target_pick_owner_role_falls_back_to_current_player", function()
    local env = _build_target_pick_env()
  ...
  it("_test_target_pick_owner_role_falls_back_to_choice_owner_role_id", function()
    local env = _build_target_pick_env()
    env.choice.target_picker_owner_role_id = nil
  ...
  it("_test_target_pick_scene_click_normalizes_string_option_id", function()
    local env = _build_target_pick_env()
  ...
  it("_test_target_pick_scene_click_rejects_payload_unit_without_mapping", function()
    local env = _build_target_pick_env()
  ...
  it("_test_ui_event_router_player_target_click_direct_submit", function()
  ...
  it("_test_target_pick_prefers_explicit_owner_role_id", function()
    local env = _build_target_pick_env()
