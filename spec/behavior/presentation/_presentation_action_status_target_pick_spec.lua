...
describe("presentation_target_pick", function()
  ...
  it("_test_target_pick_confirm_requires_lock", function()
    local env = _build_target_pick_env()
    _with_target_pick_runtime(env, function()
      canvas_event_router.bind(env.state, function()
        return env.game
  ...
  it("_test_target_pick_cancel_unlocks_and_resumes_raycast", function()
    local env = _build_target_pick_env()
    _with_target_pick_runtime(env, function(runtime)
      canvas_event_router.bind(env.state, function()
        return env.game
  ...
  it("_test_target_pick_cancel_noop_when_unlocked", function()
    local env = _build_target_pick_env()
    _with_target_pick_runtime(env, function()
      canvas_event_router.bind(env.state, function()
        return env.game
