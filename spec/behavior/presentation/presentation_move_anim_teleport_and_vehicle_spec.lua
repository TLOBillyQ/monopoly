...
describe("presentation.move_anim_teleport_and_vehicle", function()
  it("teleport_snaps_local_player_without_starting_move", function()
    local calls = {}
  ...
  it("teleport_snaps_synthetic_actor_without_force_start_move", function()
    local calls = {}
    local target_pos = nil
    local scene = support.new_scene_with_linear_tiles(2, {
      units_by_player_id = {
  ...
  it("teleport_snaps_vehicle_presentation", function()
    local calls = {}
    local target_pos = nil
    local scene = support.new_scene_with_linear_tiles(2, {
      units_by_player_id = {
  ...
  it("step_duration_uses_vehicle_accel_curve_for_short_hops", function()
    local duration = nil
  ...
  it("step_duration_falls_back_to_linear_speed_when_vehicle_accel_missing", function()
    local duration = nil
