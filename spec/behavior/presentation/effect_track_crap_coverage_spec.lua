...
describe("effect_track_crap_coverage", function()
  it("_test_nil_input_returns_nil", function()
    _with_runtime_port_mocks(function()
      _assert_eq(effect_track.coalesce_queue(nil), nil, "nil queue returns nil")
    end)
  end)

  it("_test_non_table_returns_input", function()
    _with_runtime_port_mocks(function()
      local input = "abc"
  ...
  it("_test_empty_table_returns_same_table", function()
    _with_runtime_port_mocks(function()
      local queue = {}
  ...
  it("_test_single_element_returns_same_table", function()
    _with_runtime_port_mocks(function()
      local queue = {
  ...
  it("_test_low_pressure_returns_queue_unchanged", function()
    _with_runtime_port_mocks(function()
  ...
  it("_test_high_pressure_merges_consecutive_cash_receive", function()
    _with_runtime_port_mocks(function()
  ...
  it("_test_high_pressure_preserves_non_sum_policy_kinds", function()
    _with_runtime_port_mocks(function()
      _spawn_active_tokens(5)
  ...
  it("_test_high_pressure_mixed_queue_merges_only_consecutive_cash_receive", function()
    _with_runtime_port_mocks(function()
      _spawn_active_tokens(5)
  ...
  it("_test_high_pressure_single_cash_receive_block_has_count_one", function()
    _with_runtime_port_mocks(function()
      _spawn_active_tokens(5)
      local marker = { kind = "roadblock_trigger" }
      local queue = {
