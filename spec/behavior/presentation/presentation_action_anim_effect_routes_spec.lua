...
describe("presentation.action_anim_effect_routes", function()
  it("action_anim_overlay_handler_returns_duration", function()
  ...
  it("action_anim_move_effect_uses_real_handler_duration", function()
    local state = support.build_min_state()
  ...
  it("action_anim_teleport_effect_uses_real_handler_duration_without_direction_patch", function()
    local state = support.build_min_state()
  ...
  it("action_anim_forced_relocation_uses_real_handler_duration_without_direction_patch", function()
    local state = support.build_min_state()
  ...
  it("action_anim_mine_trigger_uses_real_handler_duration_without_direction_patch", function()
    local state = support.build_min_state()
  ...
  it("action_anim_missile_waits_before_starting_handler", function()
    local state = support.build_min_state()
  ...
  it("action_anim_monster_waits_before_starting_handler", function()
    local state = support.build_min_state()
    local scheduled_delay = nil
    local scheduled_fn = nil
    local handler_calls = 0
  ...
  it("action_anim_is_silent_by_default", function()
    local state = support.build_min_state()
    local tip_calls = 0
  ...
  it("action_anim_user_tip_policy_forces_tip", function()
    local state = support.build_min_state()
    local tips = {}
  ...
  it("action_anim_debug_log_uses_info_without_tip", function()
    local state = support.build_min_state()
    local tip_calls = 0
    local info_calls = {}
  ...
  it("host_runtime_sfx_port_skips_missing_keys_and_routes_valid_calls", function()
    local sfx_calls = {}
    local sound_calls = {}
  ...
  it("action_anim_upgrade_land_routes_board_feedback", function()
    local state = support.build_min_state()
    local calls = {}
  ...
  it("action_anim_cash_receive_routes_board_feedback", function()
    local state = support.build_min_state()
    local calls = {}
  ...
  it("play_mine_trigger_prefers_player_cue_with_unit_position", function()
    local state = support.build_min_state()
    local player_calls = {}
    local tile_calls = 0
    local cleared = {}
  ...
  it("play_mine_trigger_falls_back_to_tile_position_for_player_cue", function()
    local state = support.build_min_state()
    local player_calls = {}
    local tile_calls = 0
  ...
  it("play_mine_trigger_uses_tile_cue_without_any_position_and_normalizes_minimum_delay", function()
    local state = support.build_min_state()
  ...
  it("play_mine_trigger_uses_prepare_before_feedback_without_scheduler", function()
    local state = support.build_min_state()
    local steps = {}
  ...
  it("play_missile_plays_blast_and_delays_upgrade_smoke", function()
    local state = support.build_min_state()
    local cue_calls = {}
    local scheduled_delay = nil
    local scheduled_fn = nil
  ...
  it("play_monster_plays_blast_and_delays_upgrade_smoke", function()
    local state = support.build_min_state()
    local cue_calls = {}
    local scheduled_delay = nil
    local scheduled_fn = nil
  ...
  it("play_mine_trigger_delays_snap_when_schedule_available", function()
    local state = support.build_min_state()
    local scheduled_delay = nil
    local scheduled_fn = nil
    local steps = {}
  ...
  it("action_anim_roll_screen_two_stage_timeline", function()
    local state = support.build_min_state()
  ...
  it("action_anim_roll_screen_fallback_face_when_invalid", function()
    local state = support.build_min_state()
    local nodes = _new_roll_nodes()
