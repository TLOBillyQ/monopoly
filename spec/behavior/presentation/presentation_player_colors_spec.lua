...
describe("presentation_player_colors", function()
  it("remap_by_index_integer_ids", function()
  ...
  it("remap_by_index_role_ids", function()
    player_colors.remap_by_index({
  ...
  it("remap_by_index_caps_at_4", function()
    player_colors.remap_by_index({
  ...
  it("capture_player_colors_fallbacks_on_invalid_sample", function()
    local captured = nil
    local fallback_calls = 0
