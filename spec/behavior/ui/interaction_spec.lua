...
describe("presentation_ui.interaction", function()
  ...
  it("_test_ui_intent_dispatcher_toggle_action_log_resolves_role_via_game_api", function()
    ...
    assert(_has_event(events, "显示日志屏"), "toggle_action_log should send 显示日志屏 via GameAPI role fallback")
  ...
  it("_test_ui_event_router_item_atlas_arrows_move_pages", function()
  ...
  it("_test_ui_event_router_rebind_destroys_old_listeners", function()
    local base_nodes = require("src.ui.schema.base")
    local destroyed = 0
  ...
  it("_test_raycast_pick_with_tries_multiple_apis_in_order", function()
    ...
    _with_patches({
      ...
      if hit == nil or hit.unit == nil then
        error("pick_first_hit_unit should return hit when second API succeeds")
      end
