...
describe("presentation_t5_characterization", function()
  ...
  it("on_bankruptcy_tiles_cleared_returns_true_when_sync_succeeds", function()
  ...
  it("on_bankruptcy_tiles_cleared_returns_false_when_no_state", function()
    local state_ports = _load_fresh("src.ui.ports.state")
    local ports = state_ports.build()
  ...
  it("on_bankruptcy_tiles_cleared_returns_false_when_sync_returns_false", function()
    local state_ports = _load_fresh("src.ui.ports.state")
    local ports = state_ports.build()
  ...
  it("rent_paid_handler_calls_board_feedback", function()
    local handlers = {}
    local calls = {}
  ...
  it("rent_paid_handler_skips_when_no_context", function()
    local handlers = {}
    local calls = {}
  ...
  it("rent_bankrupt_handler_calls_board_feedback", function()
    local handlers = {}
    local calls = {}
  ...
  it("tax_paid_handler_calls_board_feedback", function()
    local handlers = {}
    local calls = {}
  ...
  it("bankruptcy_handler_calls_board_feedback", function()
    local handlers = {}
    local calls = {}
  ...
  it("bankruptcy_handler_uses_player_id_directly", function()
    local handlers = {}
    local calls = {}
  ...
  it("register_node_click_skips_when_already_registered", function()
  ...
  it("register_node_click_handles_missing_nodes", function()
    local event_bindings = _load_fresh("src.ui.coord.event_bindings")
  ...
  it("register_node_click_caches_nodes", function()
    local event_bindings = _load_fresh("src.ui.coord.event_bindings")
    local runtime = require("src.ui.render.runtime_ui")
    local registered = {}
    local listeners = {}
  ...
  it("register_node_click_registers_multiple_nodes", function()
    local event_bindings = _load_fresh("src.ui.coord.event_bindings")
    local runtime = require("src.ui.render.runtime_ui")
    local registered = {}
    local listeners = {}
  ...
  it("register_node_click_handles_empty_nodes_result", function()
    local event_bindings = _load_fresh("src.ui.coord.event_bindings")
    local runtime = require("src.ui.render.runtime_ui")
    local registered = {}
    local listeners = {}
  ...
  it("register_node_click_logs_action_log_button_query_failure", function()
    local event_bindings = _load_fresh("src.ui.coord.event_bindings")
    local runtime = require("src.ui.render.runtime_ui")
  ...
  it("register_node_click_logs_action_log_button_not_found", function()
    local event_bindings = _load_fresh("src.ui.coord.event_bindings")
    local runtime = require("src.ui.render.runtime_ui")
    local always_show_nodes = require("src.ui.schema.base")
    local registered = {}
  ...
  it("build_choice_view_builds_basic_view", function()
  ...
  it("build_choice_view_uses_phase_title", function()
    local choice_builder = _load_fresh("src.ui.view.choice_builder")
  ...
  it("build_choice_view_prefers_body_lines_over_body", function()
    local choice_builder = _load_fresh("src.ui.view.choice_builder")
  ...
  it("build_choice_view_uses_default_option_label", function()
    local choice_builder = _load_fresh("src.ui.view.choice_builder")
  ...
  it("build_choice_view_copies_option_view_fields", function()
    local choice_builder = _load_fresh("src.ui.view.choice_builder")
