...
describe("presentation_ui.model_dispatch", function()
  ...
  it("_test_ui_panel_handles_invalid_cash_missing_role_id_and_empty_remote_name", function()
    local ui_panel = require("src.ui.view.panel_builder")
  ...
  it("_test_ui_panel_empty_rows_and_zero_count_do_not_leak_cache_entries", function()
    local ui_panel = require("src.ui.view.panel_builder")
    local statuses = ui_panel.build_player_statuses({
      players = {},
    }, nil, 2)
    ...
    local row = statuses and statuses[1] or nil
    assert(row ~= nil, "empty panel row should exist")
  ...
  it("_test_ui_model_player_slot_map_and_choice_owner", function()
    ...
    assert(model.panel and model.panel.auto_label_by_player and model.panel.auto_label_by_player[1] == "托管",
      "player1 auto label should use fixed delegate copy")
    assert(model.panel and model.panel.auto_label_by_player and model.panel.auto_label_by_player[2] == "托管",
      "player2 auto label should use fixed delegate copy")
  end)

  it("_test_panel_auto_label_stays_fixed_across_auto_states", function()
  ...
  it("_test_panel_turn_label_defaults_missing_countdown_to_zero", function()
    local panel_view = require("src.ui.view.panel_builder")
  ...
  it("_test_panel_slice_update_refreshes_only_requested_flags", function()
    ...
    assert(updated.auto_label == auto_label, "auto-label-only refresh should keep fixed delegate copy")
