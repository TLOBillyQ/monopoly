...
describe("suites.runtime.misc_landing_visual_hold", function()
  ...
  it("landing_visual_hold_start_repairs_attached_state_when_game_is_already_active", function()
    local state = {}
    local game = {
      dirty = {},
      turn = {
  ...
  it("landing_visual_hold_mark_release_pending_repairs_attached_state", function()
    local state = {}
    local game = {
      dirty = {},
      turn = {
  ...
  it("landing_visual_hold_clear_game_repairs_attached_state", function()
    local state = {}
    local game = {
      dirty = {},
      turn = {
  ...
  it("landing_visual_hold_state_wins_over_stale_game_turn_flags", function()
    local state = {}
    local game = {
      dirty = {},
      turn = {
