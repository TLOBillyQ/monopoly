...
describe("number_utils", function()
  ...
  describe("to_integer tostring-fallback guards pcall result (L92)", function()
    it("returns nil when __tostring throws even if error string parses as integer", function()
      local wrapped = setmetatable({}, {
