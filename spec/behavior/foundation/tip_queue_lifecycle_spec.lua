...
describe("tip_queue_lifecycle", function()
  it("uses_fifo_queue_without_override", function()
    local shown = {}
    local timers = {}
  ...
  it("dedupes_same_semantic_key_across_active_and_pending", function()
    local shown = {}
    local timers = {}
  ...
  it("only_blocks_inter_turn_for_blocking_tips", function()
    local timers = {}
  ...
  it("non_blocking_tip_never_gates_inter_turn", function()
    _with_queue_runtime(function()
      tip_queue.configure_runtime({
        presenter = function() end,
        scheduler = function()
  ...
  it("clear_cancels_stale_timeout_without_replaying_queue", function()
    local shown = {}
    local timers = {}
