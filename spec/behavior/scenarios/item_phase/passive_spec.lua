...
describe("gameplay_item_phase_passive", function()
  it("item_phase_passive_happy_path_use_then_continue_finishes_phase", function()
  ...
  it("item_phase_passive_effect_group_blocks_same_group_slots", function()
    local g = _new_game({ ai = {} })
    local player = g:current_player()
    player.inventory:add({ id = item_ids.remote_dice })
    player.inventory:add({ id = item_ids.remote_dice })
  ...
  it("item_phase_passive_auto_skips_with_empty_inventory", function()
    local g = _new_game({ ai = {} })
    local player = g:current_player()
  ...
  it("item_phase_passive_followup_choice_roundtrip", function()
    local g = _new_game({ ai = {} })
    local player = g:current_player()
  ...
  it("item_phase_passive_ai_path_remains_auto", function()
  ...
  it("item_phase_passive_effect_group_persists_across_phases_and_clears_on_end_turn", function()
    local g = _new_game({ ai = {} })
    local player = g:current_player()
