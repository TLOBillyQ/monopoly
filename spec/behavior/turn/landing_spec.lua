...
describe("landing", function()
  ...
  it("land_on_start_reward", function()
    ...
    _assert_eq(p.cash, before + constants.pass_start_bonus, "landing on start should grant reward")
  end)
  ...
  it("land_on_start_reward_when_passed_start_zero", function()
    ...
    assert(not res, "landing resolver should not wait")
    _assert_eq(p.cash, before + constants.pass_start_bonus, "passed_start zero should still grant start reward")
  end)
  ...
  it("land_on_start_skips_duplicate_passed_start_reward", function()
    ...
    assert(not res, "landing resolver should not wait")
    _assert_eq(p.cash, before, "passed_start reward should not be duplicated on start landing")
  end)
  ...
  it("land_on_start_rich_deity_doubles_reward", function()
    ...
    assert(not res, "landing resolver should not wait")
    _assert_eq(p.cash, before + constants.pass_start_bonus * 2, "rich deity should double start reward")
  end)
