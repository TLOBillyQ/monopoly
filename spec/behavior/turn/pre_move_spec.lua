...
describe("turn_flow_pre_move", function()
  it("_test_resolve_wait_choice_when_no_wait_action_anim", function()
  ...
  it("_test_resolve_wait_action_anim_when_flag_set", function()
    local player = { id = 1, status = {} }
    local turn_mgr = _build_turn_mgr({ player = player })
  ...
  it("_test_default_next_args_built_from_player_total_raw_total", function()
    local player = { id = 1, status = {} }
    local turn_mgr = _build_turn_mgr({ player = player })
    local captured_args
  ...
  it("_test_provided_next_args_used_as_is", function()
    local player = { id = 1, status = {} }
  ...
  it("_test_no_item_phase_continues_to_move", function()
    local player = { id = 1, status = {} }
    local turn_mgr = _build_turn_mgr({ player = player })
