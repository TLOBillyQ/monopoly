...
describe("vehicle_helper", function()
  local _config_reset = require("spec.support.config_reset")
  before_each(function() _config_reset.reset_all() end)

  it("create_with_valid_opts_returns_result_and_emits_event", function()
  ...
  it("create_with_missing_param_returns_error", function()
    support.with_patches({
      _stub_game_api(),
    }, function()
      _with_feature_enabled(function()
  ...
  it("create_when_disabled_returns_error", function()
  ...
  it("create_when_host_api_fails_returns_error", function()
    support.with_patches({
      _stub_game_api({
  ...
  it("copy_with_valid_opts_returns_result_and_emits_event", function()
    local captured, event_patch = _capture_events()
    support.with_patches({
      event_patch,
      _stub_game_api(),
  ...
  it("copy_with_missing_param_returns_error", function()
    support.with_patches({
      _stub_game_api(),
    }, function()
      _with_feature_enabled(function()
  ...
  it("destroy_returns_true_and_emits_event", function()
    local captured, event_patch = _capture_events()
    support.with_patches({
      event_patch,
      _stub_game_api(),
  ...
  it("destroy_with_missing_param_returns_error", function()
    support.with_patches({
      _stub_game_api(),
    }, function()
      _with_feature_enabled(function()
  ...
  it("get_driving_vehicle_returns_vehicle_without_feature_guard", function()
    support.with_patches({
      _stub_game_api(),
    }, function()
      vehicle_feature.set_enabled(false)
  ...
  it("get_driving_vehicle_with_missing_param_returns_error", function()
  ...
  it("enter_returns_true_and_emits_event", function()
    local captured, event_patch = _capture_events()
    support.with_patches({
      event_patch,
      _stub_game_api(),
  ...
  it("enter_when_disabled_returns_error", function()
    vehicle_feature.set_enabled(false)
    local ok, err = vehicle_helper.enter(_mock_life_entity, _mock_vehicle)
  ...
  it("enter_with_missing_life_entity_returns_error", function()
    support.with_patches({
      _stub_game_api(),
    }, function()
      _with_feature_enabled(function()
  ...
  it("exit_returns_true_and_emits_event", function()
    local captured, event_patch = _capture_events()
    support.with_patches({
      event_patch,
      _stub_game_api(),
  ...
  it("exit_when_disabled_returns_error", function()
    vehicle_feature.set_enabled(false)
    local ok, err = vehicle_helper.exit(_mock_life_entity)
  ...
  it("move_returns_true_and_emits_event", function()
  ...
  it("move_with_missing_direction_returns_error", function()
    support.with_patches({
      _stub_game_api(),
    }, function()
      _with_feature_enabled(function()
  ...
  it("stop_returns_true_and_emits_event", function()
  ...
  it("stop_with_missing_vehicle_returns_error", function()
    support.with_patches({
      _stub_game_api(),
    }, function()
      _with_feature_enabled(function()
  ...
  it("reset_returns_true_and_emits_event", function()
  ...
  it("reset_when_disabled_returns_error", function()
    vehicle_feature.set_enabled(false)
