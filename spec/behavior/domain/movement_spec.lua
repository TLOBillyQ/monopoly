...
local move_anim_support = require("spec.support.move_anim_support")
...
describe("movement", function()
  ...
  it("movement_backward_without_move_dir_keeps_nil", function()
    local g = _new_game()
    local p = g:current_player()
  ...
  it("movement_fresh_roll_ignores_stale_move_dir", function()
    local g = _new_game()
  ...
  it("movement_single_step_sets_move_dir_to_next_heading", function()
    local g = _new_game()
    local p = g:current_player()
    g:update_player_position(p, g.board:index_of_tile_id(42))
    local res = movement.move(g, p, 1, { branch_parity = 1, skip_market_check = true })
  ...
  it("movement_multi_step_sets_move_dir_to_next_heading", function()
    local g = _new_game()
    local p = g:current_player()
  ...
  it("inner_exit_tiles_persist_outer_heading", function()
    local g = _new_game()
    local p = g:current_player()
  ...
  it("backward_from_exit_tiles_uses_outer_heading", function()
    local g = _new_game()
    local p = g:current_player()
  ...
  it("inner_backward_without_move_dir_uses_reverse_fallback", function()
    local g = _new_game()
    local p = g:current_player()
    local cases = {
  ...
  it("exit_inner_to_entry_tile_skips_reentering_next_turn", function()
    local g = _new_game()
    local p = g:current_player()
  ...
  it("skip_next_inner_entry_only_blocks_current_entry_tile_once", function()
    local g = _new_game()
    local p = g:current_player()
  ...
  it("sync_move_dir_after_position_change_covers_core_modes", function()
    local g = _new_game()
    local p = g:current_player()
  ...
  it("same_move_enters_inner_only_once", function()
    local g = _new_game()
    local p = g:current_player()
  ...
  it("inner_ring_fresh_roll_keeps_saved_direction", function()
    local g = _new_game()
    local p = g:current_player()
    local cases = {
  ...
  it("resume_forward_from_inner_ring_keeps_explicit_direction", function()
    local g = _new_game()
    local p = g:current_player()
  ...
  it("resume_forward_requires_explicit_direction", function()
    local g = _new_game()
    local p = g:current_player()
  ...
  it("move_anim_play_sequence_emits_step_sound_per_visited_tile", function()
    local calls = {}
    local step_calls = {}
    local scheduled = {}
  ...
  it("resolve_outer_next_returns_outer_next_when_no_entry", function()
    local map = {
      outer_next = { [1] = 2 },
      entry_points = {},
      outer_prev = {},
  ...
  it("resolve_outer_next_returns_inner_on_even_parity", function()
    local map = {
      outer_next = { [1] = 2 },
  ...
  it("resolve_outer_next_returns_outer_when_inner_entry_is_blocked", function()
    local map = {
      outer_next = { [1] = 2 },
      entry_points = { [1] = { inner_id = 10 } },
      outer_prev = { [1] = 99 },
  ...
  it("resolve_outer_next_returns_nil_when_no_outer_next", function()
    local map = {
      outer_next = {},
      entry_points = {},
      outer_prev = {},
  ...
  it("resolve_fresh_forward_next_returns_fresh_next_when_facing_nil", function()
    local map = {
  ...
  it("resolve_fresh_forward_next_returns_nil_when_facing_not_nil", function()
    local map = {
      fresh_forward_next = { [1] = 5 },
    }
  ...
  it("resolve_fresh_forward_next_returns_nil_when_no_fresh_forward_next", function()
    local map = {}
    local result = _resolve_fresh_forward_next(map, 1, nil)
    _assert_eq(result, nil, "should return nil when no fresh_forward_next")
  end)

  it("resolve_facing_next_returns_neighbor_in_facing_direction", function()
  ...
  it("resolve_fallback_next_returns_any_dir_avoiding_back_when_not_unique", function()
  ...
  it("resolve_fallback_next_returns_any_dir_when_back_nil", function()
    local neigh = { up = 10 }
    local result = _resolve_fallback_next(neigh, nil)
    _assert_eq(result, 10, "should return any dir when back direction is nil")
  end)

  it("resolve_backward_next_returns_facing_reverse_neighbor_when_available", function()
    local map = {
      outer_prev = { [1] = 30 },
  ...
  it("resolve_backward_next_returns_outer_prev_before_map_fallback", function()
    local map = {
      outer_prev = { [1] = 30 },
      backward_fallback = { [1] = 40 },
    }
  ...
  it("resolve_backward_next_returns_backward_fallback_before_neighbor_fallback", function()
    local map = {
      outer_prev = {},
      backward_fallback = { [1] = 40 },
    }
  ...
  it("resolve_backward_next_returns_unique_neighbor_when_only_one_remains", function()
    local map = {
      outer_prev = {},
      backward_fallback = {},
    }
  ...
  it("resolve_backward_next_returns_sorted_any_neighbor_when_multiple_remain", function()
    local map = {
      outer_prev = {},
      backward_fallback = {},
    }
  ...
  it("resolve_backward_next_source_reports_facing_hit", function()
    local map = {
      outer_prev = {},
      backward_fallback = {},
    }
  ...
  it("resolve_backward_next_source_reports_outer_prev_hit", function()
    local map = {
      outer_prev = { [1] = 30 },
      backward_fallback = { [1] = 40 },
    }
  ...
  it("resolve_backward_next_source_reports_backward_fallback_hit", function()
    local map = {
      outer_prev = {},
      backward_fallback = { [1] = 40 },
    }
  ...
  it("pick_any_dir_returns_first_sorted_dir", function()
  ...
  it("pick_any_dir_avoids_avoid_dir", function()
    local neigh = { up = 10, down = 20 }
  ...
  it("pick_any_dir_returns_nil_when_all_avoided", function()
    local neigh = { up = 10 }
    local dir, id = _pick_any_dir(neigh, "up")
  ...
  it("pick_unique_dir_returns_unique_when_only_one_option", function()
    local neigh = { up = 10 }
  ...
  it("pick_unique_dir_returns_nil_when_multiple_options", function()
    local neigh = { up = 10, down = 20 }
    local dir, id = _pick_unique_dir(neigh, nil)
  ...
  it("pick_unique_dir_returns_unique_when_others_avoided", function()
    local neigh = { up = 10, down = 20 }
  ...
  it("collect_indices_by_distance_returns_empty_for_zero_distance", function()
    local g = _new_game()
  ...
  it("collect_indices_by_distance_groups_tiles_by_manhattan_radius", function()
    local g = _new_game()
    local start_idx = g.board:index_of_tile_id(1)
  ...
  it("collect_indices_by_distance_does_not_exceed_max_dist", function()
    local g = _new_game()
    local start_idx = g.board:index_of_tile_id(1)
    local start_tile = g.board:get_tile(start_idx)
  ...
  it("manhattan_distance_uses_tile_coordinates", function()
  ...
  it("flatten_by_distance_returns_empty_for_empty_input", function()
  ...
  it("flatten_by_distance_orders_by_distance", function()
    local by_dist = {
      [1] = { 10, 11 },
      [2] = { 20, 21 },
      [3] = { 30 },
  ...
  it("flatten_by_distance_skips_missing_distances", function()
    local by_dist = {
      [1] = { 10 },
      [3] = { 30 },
    }
  ...
  it("flatten_by_distance_handles_max_dist_greater_than_entries", function()
    local by_dist = {
      [1] = { 10 },
    }
