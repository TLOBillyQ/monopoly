...
describe("board_direction_collect_crap_coverage", function()
  local _config_reset = require("spec.support.config_reset")
  before_each(function() _config_reset.reset_all() end)

  it("_test_collect_forward_indices_walks_ring_forward", function()
  ...
  it("_test_collect_forward_indices_zero_steps_returns_empty", function()
    local board, player = _linear_ring_board(1, nil)
  ...
  it("_test_collect_forward_indices_step_field_matches_distance", function()
  ...
  it("_test_collect_backward_indices_walks_ring_backward", function()
  ...
  it("_test_collect_backward_indices_zero_steps_returns_empty", function()
    local board, player = _linear_ring_board(1, nil)
    local result = direction.collect_backward_indices(board, player, 0)
    _assert_eq(#result.list, 0, "zero backward steps: empty list")
  end)

  it("_test_collect_backward_indices_step_field_matches_distance", function()
  ...
  it("_test_try_resolve_forward_next_id_returns_outer_next", function()
    local map = {
      outer_next = { [1] = 2 },
      outer_prev = {},
      neighbors = {},
  ...
  it("_test_try_resolve_forward_next_id_returns_nil_when_no_next", function()
    local map = {
      outer_next = {},
      outer_prev = {},
      neighbors = { [1] = {} },
  ...
  it("_test_collect_forward_and_backward_do_not_include_player_position", function()
    local board, player = _linear_ring_board(1, nil)
