...
describe("land", function()
  ...
  it("ai_picks_land_purchase", function()
    ...
    assert(g:player_cash(ai_player) == before_cash - tile_ref.price, "AI cash should decrease by land price")
  ...
  it("choice_resolver_executes_canonical_landing_optional_effect", function()
    ...
    assert(g:player_cash(p) < before_cash, "canonical optional choice should still execute buy_land")
  ...
  it("apply_tax_with_pending_tax_free_skips_payment", function()
    ...
    if tax_idx then
      ...
      assert(g:player_cash(p) == before_cash, "_apply_tax should skip payment when pending_tax_free is set")
