...
describe("movement_dice", function()
  ...
  it("_test_roll_dice_with_rng", _roll_dice_extended_tests[1])

  it("_test_roll_dice_single_override", _roll_dice_extended_tests[2])

  it("_test_roll_dice_zero_count", _roll_dice_extended_tests[3])

  it("_test_roll_dice_single_die_rng", _roll_dice_extended_tests[4])

  it("_test_roll_dice_more_overrides", _roll_dice_extended_tests[5])

  it("_test_roll_dice_exact_overrides", _roll_dice_extended_tests[6])
end)
