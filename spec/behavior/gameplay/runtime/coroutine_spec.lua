...
describe("gameplay.coroutine", function()
  it("turn_engine_defaults_to_coroutine_mode", function()
  ...
  it("turn_engine_coroutine_mode_resolves_wait_choice", function()
    local g = support.new_game()
  ...
  it("coroutine_mode_resolves_wait_action_anim", function()
    local g = support.new_game()
    local anim_seq = 99
  ...
  it("coroutine_mode_resolves_detained_wait", function()
    local g = support.new_game()
  ...
  it("coroutine_mode_resolves_inter_turn_wait", function()
    local g = support.new_game()
  ...
  it("coroutine_mode_resolves_wait_landing_visual", function()
    local g = support.new_game()
  ...
  it("coroutine_mode_full_turn_lifecycle", function()
    local g = support.new_game()
    local visited = {}
  ...
  it("await_choice_bridges_action_anim_into_wait_state", function()
    local g = support.new_game()
  ...
  it("await_action_anim_advances_through_queue", function()
    local g = support.new_game()
  ...
  it("await_action_anim_defers_callback_until_queue_drains", function()
    local g = support.new_game()
  ...
  it("await_move_anim_waits_for_matching_seq", function()
    local g = support.new_game()
  ...
  it("await_move_anim_debug_log_reports_pending_action_details", function()
    local g = support.new_game()
  ...
  it("await_landing_visual_marks_release_pending_after_wait", function()
    local g = support.new_game()
    landing_visual_hold.start(g)
    local session = _new_await_session(g)
  ...
  it("await_inter_turn_wait_clears_action_and_advances_player", function()
    local g = support.new_game()
    g.turn.inter_turn_wait_active = true
    local next_calls = 0
    local session = _new_await_session(g, {
  ...
  it("await_inter_turn_wait_blocks_until_tip_queue_drains", function()
    local g = support.new_game()
    local next_calls = 0
    local timers = {}
    local session = _new_await_session(g, {
  ...
  it("turn_script_wait_move_anim_yields_and_resumes", function()
    local g = support.new_game()
  ...
  it("await_seconds_waits_until_elapsed", function()
  ...
  it("await_action_resolves_immediately_for_ai_player", function()
  ...
  it("await_action_yields_for_human_player", function()
  ...
  it("await_action_resolves_for_human_player_with_pending_action", function()
    local g = support.new_game({ ai = { [2] = true } })
  ...
  it("coroutine_mode_resolves_wait_action", function()
    local g = support.new_game({ ai = { [2] = true } })
