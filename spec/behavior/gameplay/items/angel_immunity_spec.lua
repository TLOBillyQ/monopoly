...
describe("gameplay_angel_immunity", function()
  ...
  it("roadblock angel passes through and keeps roadblock", function()
    ...
    assert(move_result.stopped_on_roadblock ~= true, "angel should not stop on roadblock")
    assert(game.board:has_roadblock(2) == true, "roadblock should remain when angel passes through")
    assert(player.position ~= 2, "angel should continue past the roadblock tile")
  end)
