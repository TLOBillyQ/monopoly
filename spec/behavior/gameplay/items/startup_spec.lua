...
describe("gameplay_items_startup", function()
  it("monster_startup_profile_runs_choice_to_action_anim", function()
  ...
  it("missile_startup_profile_defers_hospital_followup_until_after_anim", function()
  ...
  it("mine_startup_profile_other_player_triggers_immediately_after_placement", function()
  ...
  it("mine_startup_profile_owner_triggers_on_third_own_turn", function()
    local g, _ = _new_profile_game("mine")
    local p1 = g.players[1]
    local mine_index = p1.position
    local mine_tile = assert(g.board:get_tile(mine_index), "mine startup tile should exist")
  ...
  it("strong_card_startup_profile_transfers_target_tile_on_use", function()
  ...
  it("strong_card_startup_profile_allows_free_rent_after_skipping_strong", function()
    local g, _, player, target_tile, rent_prompt = _advance_strong_card_staging_to_rent_prompt()
    local owner = g.players[2]
    local target_state_before = _tile_state(g, target_tile)
    local player_cash_before = g:player_balance(player, "金币")
  ...
  it("strong_card_startup_profile_falls_back_to_direct_rent_after_skipping_both_cards", function()
    local g, _, player, target_tile, rent_prompt = _advance_strong_card_staging_to_rent_prompt()
    local owner = g.players[2]
    local target_state_before = _tile_state(g, target_tile)
  ...
  it("post_action_item_phase_keeps_reactive_rent_cards_out_after_skipping_strong", function()
    local g, _, player, target_tile, rent_prompt = _advance_strong_card_staging_to_rent_prompt()
    local phases = phase_registry.build_default_phases()
    local owner = g.players[2]
    local target_state_before = _tile_state(g, target_tile)
  ...
  it("post_action_auto_phase_waits_for_action_anim_followup", function()
  ...
  it("pre_action_item_phase_remote_dice_then_mine_reopens_before_roll", function()
    local g, _ = _new_profile_game("strong_card")
    local player = g.players[1]
    g.auto_play_port.is_auto_player = function()
      return false
  ...
  it("combo_roadblock_mine_profile_exposes_both_cards_in_pre_action", function()
  ...
  it("roll_phase_no_longer_opens_active_item_window", function()
  ...
  it("dice_multiplier_used_in_pre_action_changes_same_turn_roll_total", function()
    local g, _ = _new_profile_game("dice_multiplier")
    local player = g.players[1]
    g.last_turn = {}
    g.rng = {
  ...
  it("steal_startup_profile_multi_item_choice_resumes_to_chance", function()
  ...
  it("steal_startup_profile_single_item_auto_steal_resumes_to_chance", function()
  ...
  it("steal_queue_startup_profile_skip_opens_next_target_and_resumes", function()
  ...
  it("steal_startup_profile_cancel_item_picker_keeps_state_and_resumes", function()
    local g, _ = _new_profile_game("steal")
    g.auto_play_port.is_auto_player = function()
      return false
    end
  ...
  it("choice_builders_reserve_base_inline_for_item_slots_only", function()
    local g, _ = _new_profile_game("steal")
    local player = g.players[1]
  ...
  it("circle_startup_profile_second_remote_roll_reaches_chance45_after_market_resume", function()
    local g, _ = _new_profile_game("circle")
    local player = g.players[1]
    local remote_dice_id = item_ids.remote_dice
    g.last_turn = {}
  ...
  it("circle_market_bought_roadblock_then_mine_can_chain_in_post_action", function()
  ...
  it("circle_market_bought_mine_remains_available_next_turn_after_skipping_reopened_post_action", function()
    local g, player, roadblock_id, mine_id = _setup_circle_market_bought_roadblock_and_mine()
