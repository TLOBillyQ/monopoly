...
describe("v102_extension_contract", function()
  ...
  it("host_install_wires_purchase_skins_to_paid_goods", function()
    local host_install = require("src.app.host_install")
    ...
    _with_patches({
      ...
      assert(captured ~= nil, "skin purchase should start paid purchase")
    ...
    assert(type(captured.entry.on_purchase) == "function", "skin purchase should carry fulfillment callback")
  ...
  it("sign_in_integration_is_implemented", function()
    ...
    assert(sign_in.host_pending ~= true, "sign_in should no longer be a host-pending noop")
  ...
  it("leaderboard_integration_is_implemented", function()
    local leaderboard = require("src.app.host_integrations.leaderboard")

    assert(leaderboard.host_pending ~= true, "leaderboard should no longer be a host-pending noop")
