...
return {
  ...
  tests = {
    ...
    _case("_test_chance_collect_from_others_bankrupts_unable_payer"),
    _case("_test_rent_bankruptcy_leaves_payer_cash_negative"),
    _case("_test_hospital_insufficient_funds_does_not_leave_positive_cash"),
