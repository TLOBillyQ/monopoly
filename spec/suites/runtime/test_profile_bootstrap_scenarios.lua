...
local function _test_roadblock_bootstraps_inventory_and_position()
  local game = support.apply_profile("roadblock")
  support.assert_player_on_tile_id(game, 1, 7)
  support.assert_inventory_counts(game.players[1], { [2004] = 1 })
end

local function _test_combo_roadblock_mine_bootstraps_dual_items()
...
local function _test_share_wealth_bootstraps_cash_gap_and_item()
...
local function _test_tax_probe_bootstraps_target_choice_setup()
...
local function _test_deity_transfer_bootstraps_source_target_and_status()
...
local function _test_rich_angel_bootstraps_dual_deity_cards()
  local game = support.apply_profile("rich_angel")
  support.assert_player_on_tile_id(game, 1, 7)
  support.assert_inventory_counts(game.players[1], { [2017] = 1, [2019] = 1 })
end

local function _test_free_rent_bootstraps_rent_response_setup()
...
local function _test_dice_multiplier_bootstraps_pre_action_setup()
...
local function _test_mine_relay_bootstraps_overlay_and_roles()
...
return {
  ...
  tests = {
    ...
    { name = "roadblock_bootstraps_inventory_and_position", run = _test_roadblock_bootstraps_inventory_and_position },
    { name = "combo_roadblock_mine_bootstraps_dual_items", run = _test_combo_roadblock_mine_bootstraps_dual_items },
    { name = "share_wealth_bootstraps_cash_gap_and_item", run = _test_share_wealth_bootstraps_cash_gap_and_item },
    { name = "tax_probe_bootstraps_target_choice_setup", run = _test_tax_probe_bootstraps_target_choice_setup },
    { name = "deity_transfer_bootstraps_source_target_and_status", run = _test_deity_transfer_bootstraps_source_target_and_status },
    { name = "rich_angel_bootstraps_dual_deity_cards", run = _test_rich_angel_bootstraps_dual_deity_cards },
    { name = "free_rent_bootstraps_rent_response_setup", run = _test_free_rent_bootstraps_rent_response_setup },
    { name = "dice_multiplier_bootstraps_pre_action_setup", run = _test_dice_multiplier_bootstraps_pre_action_setup },
    { name = "mine_relay_bootstraps_overlay_and_roles", run = _test_mine_relay_bootstraps_overlay_and_roles },
  },
}
