...
-- ============================================================
local function _test_linear_path_produces_single_branch_with_12_entries()
  local g = _new_game()
...
-- ============================================================
local function _test_forked_path_produces_two_branches()
  local g = _new_game()
  local p = g:current_player()
...
-- ============================================================
local function _test_dead_end_stops_at_board_edge()
  local g = _new_game()
  local p = g:current_player()
...
-- ============================================================
local function _test_duration_is_positive_number_in_payload()
  local g = _new_game()
  local p = g:current_player()
...
return {
  name = "domain.clear_obstacles_branch_walk",
  tests = {
    {
      name = "linear_path_produces_single_branch_with_12_entries",
      run = _test_linear_path_produces_single_branch_with_12_entries,
    },
    {
      name = "forked_path_produces_two_branches",
      run = _test_forked_path_produces_two_branches,
    },
    {
      name = "dead_end_stops_at_board_edge",
      run = _test_dead_end_stops_at_board_edge,
    },
    {
      name = "duration_is_positive_number_in_payload",
      run = _test_duration_is_positive_number_in_payload,
    },
  },
}
