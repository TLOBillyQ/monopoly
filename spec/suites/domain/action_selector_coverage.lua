...
local function test_pick_target_player_unknown_item_returns_nil()
...
local function test_pick_target_share_wealth_not_richest_returns_richest_other()
...
local function test_pick_target_share_wealth_is_richest_returns_nil()
  local p1 = _make_player("p1")
  local p2 = _make_player("p2")
...
local function test_pick_target_exile_returns_richest_other()
  local p1 = _make_player("p1")
  local p2 = _make_player("p2")
...
local function test_pick_target_tax_returns_richest_other()
  local p1 = _make_player("p1")
  local p2 = _make_player("p2")
...
local function test_pick_target_poor_returns_richest_other()
  local p1 = _make_player("p1")
  local p2 = _make_player("p2")
...
local function test_pick_target_exile_skips_eliminated()
  local p1 = _make_player("p1")
...
local function test_pick_target_exile_respects_options_filter()
  local p1 = _make_player("p1")
  local p2 = _make_player("p2")
  local p3 = _make_player("p3")
...
local function test_pick_target_invite_deity_prefers_angel()
  local p1 = _make_player("p1")
  local p2 = _make_player("p2")
  local p3 = _make_player("p3")
...
local function test_pick_target_invite_deity_falls_back_to_rich()
  local p1 = _make_player("p1")
  local p2 = _make_player("p2")
...
local function test_pick_target_invite_deity_no_targets_returns_nil()
  local p1 = _make_player("p1")
  local p2 = _make_player("p2")
...
local function test_pick_target_send_poor_player_has_poor_returns_richest()
  local p1 = _make_player("p1")
  local p2 = _make_player("p2")
  local game = _make_game({ p1, p2 }, {
...
local function test_pick_target_send_poor_no_poor_deity_returns_nil()
  local p1 = _make_player("p1")
  local p2 = _make_player("p2")
  local game = _make_game({ p1, p2 }, {
    balances = { p1 = 10, p2 = 800 },
...
local function test_richest_other_no_eligible_others_returns_nil()
  local p1 = _make_player("p1")
  local p2 = _make_player("p2", { eliminated = true })
...
return {
  name = "domain action selector coverage",
  tests = {
    { name = "pick_target unknown item returns nil", run = test_pick_target_player_unknown_item_returns_nil },
    { name = "pick_target share_wealth not richest returns richest other", run = test_pick_target_share_wealth_not_richest_returns_richest_other },
    { name = "pick_target share_wealth is richest returns nil", run = test_pick_target_share_wealth_is_richest_returns_nil },
    { name = "pick_target exile returns richest other", run = test_pick_target_exile_returns_richest_other },
    { name = "pick_target tax returns richest other", run = test_pick_target_tax_returns_richest_other },
    { name = "pick_target poor returns richest other", run = test_pick_target_poor_returns_richest_other },
    { name = "pick_target exile skips eliminated", run = test_pick_target_exile_skips_eliminated },
    { name = "pick_target exile respects options filter", run = test_pick_target_exile_respects_options_filter },
    { name = "pick_target invite_deity prefers angel", run = test_pick_target_invite_deity_prefers_angel },
    { name = "pick_target invite_deity falls back to rich", run = test_pick_target_invite_deity_falls_back_to_rich },
    { name = "pick_target invite_deity no targets returns nil", run = test_pick_target_invite_deity_no_targets_returns_nil },
    { name = "pick_target send_poor player has poor returns richest", run = test_pick_target_send_poor_player_has_poor_returns_richest },
    { name = "pick_target send_poor no poor deity returns nil", run = test_pick_target_send_poor_no_poor_deity_returns_nil },
    { name = "richest_other no eligible others returns nil", run = test_richest_other_no_eligible_others_returns_nil },
  },
}
