...
local function _test_remote_priority_returns_nil_for_missing_tile()
...
local function _test_remote_priority_ranks_item_tile()
...
local function _test_remote_priority_ranks_chance_tile()
...
local function _test_remote_priority_ranks_empty_land_tile()
...
local function _test_remote_priority_ranks_self_owned_land_tile()
  local player = { id = 7 }
...
local function _test_remote_priority_ranks_enemy_owned_land_tile()
  local rank, score = _call_remote_priority({ id = 7 }, {
    type = "land",
    owner_id = 2,
    level = 1,
...
local function _test_remote_priority_ranks_market_tile()
...
return {
  name = "remote_priority_crap_coverage",
  tests = {
    { name = "remote_priority_returns_nil_for_missing_tile", run = _test_remote_priority_returns_nil_for_missing_tile },
    { name = "remote_priority_ranks_item_tile", run = _test_remote_priority_ranks_item_tile },
    { name = "remote_priority_ranks_chance_tile", run = _test_remote_priority_ranks_chance_tile },
    { name = "remote_priority_ranks_empty_land_tile", run = _test_remote_priority_ranks_empty_land_tile },
    { name = "remote_priority_ranks_self_owned_land_tile", run = _test_remote_priority_ranks_self_owned_land_tile },
    { name = "remote_priority_ranks_enemy_owned_land_tile", run = _test_remote_priority_ranks_enemy_owned_land_tile },
    { name = "remote_priority_ranks_market_tile", run = _test_remote_priority_ranks_market_tile },
  },
}
