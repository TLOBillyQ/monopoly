...
local function test_roll_dice_override_values_exact_count()
...
local function test_roll_dice_override_values_fewer_than_count_uses_last()
...
local function test_roll_dice_override_single_value_repeats()
...
local function test_roll_dice_with_rng()
  local call_count = 0
  local rng = {
...
local function test_roll_dice_empty_override_uses_rng()
  local rng = {
...
local function test_resolve_phase_wait_result_nil_phase_res_defaults()
  local player = { id = 1 }
...
local function test_resolve_phase_wait_result_wait_action_anim_true()
  local player = { id = 2 }
...
local function test_resolve_phase_wait_result_with_custom_next_args()
  local player = { id = 3 }
...
local function test_resolve_phase_wait_result_nil_next_args_builds_default()
  local player = { id = 4 }
...
local function test_phase_roll_with_pre_move_queues_anim_and_returns_wait()
...
local function test_phase_roll_with_pre_move_no_anim_gate_returns_pre_move()
...
local function test_phase_roll_with_pre_move_skip_anim_bypasses_gate()
  local game, anim_queued = _make_game(true)
...
local function test_phase_roll_direct_passes_through_anim_state()
  local game, anim_queued = _make_game(true)
...
local function test_phase_roll_direct_maps_pre_move_to_move()
  local game, _ = _make_game(false)
...
return {
  name = "domain roll coverage",
  tests = {
    { name = "roll_dice override values exact count", run = test_roll_dice_override_values_exact_count },
    { name = "roll_dice override values fewer than count uses last", run = test_roll_dice_override_values_fewer_than_count_uses_last },
    { name = "roll_dice override single value repeats", run = test_roll_dice_override_single_value_repeats },
    { name = "roll_dice with rng", run = test_roll_dice_with_rng },
    { name = "roll_dice empty override uses rng", run = test_roll_dice_empty_override_uses_rng },
    { name = "resolve_phase_wait_result nil phase_res defaults", run = test_resolve_phase_wait_result_nil_phase_res_defaults },
    { name = "resolve_phase_wait_result wait_action_anim=true", run = test_resolve_phase_wait_result_wait_action_anim_true },
    { name = "resolve_phase_wait_result with custom next_args", run = test_resolve_phase_wait_result_with_custom_next_args },
    { name = "resolve_phase_wait_result nil next_args builds default", run = test_resolve_phase_wait_result_nil_next_args_builds_default },
    { name = "phase_roll_with_pre_move queues anim and returns wait", run = test_phase_roll_with_pre_move_queues_anim_and_returns_wait },
    { name = "phase_roll_with_pre_move no anim gate returns pre_move", run = test_phase_roll_with_pre_move_no_anim_gate_returns_pre_move },
    { name = "phase_roll_with_pre_move skip_anim bypasses gate", run = test_phase_roll_with_pre_move_skip_anim_bypasses_gate },
    { name = "phase_roll_direct passes through anim state", run = test_phase_roll_direct_passes_through_anim_state },
    { name = "phase_roll_direct maps pre_move to move", run = test_phase_roll_direct_maps_pre_move_to_move },
  },
}
