...
local function _test_move_anim_synthetic_actor_receives_speed_modifier()
...
return {
  name = "presentation.move_anim_speed_modifier_synthetic",
  tests = {
    { name = "synthetic_actor_receives_speed_modifier", run = _test_move_anim_synthetic_actor_receives_speed_modifier },
  },
}
