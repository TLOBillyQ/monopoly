local EggyLayer = require("Manager.Adapter.Eggy.EggyLayer")
...
require "Manager.Adapter.Eggy.Macro"
...
function EggyRuntime.install()
  ...
  LuaAPI.global_register_trigger_event({ EVENT.GAME_INIT }, function()
    ...
    require "Manager.Adapter.Eggy.ECA"
    UIManager.forward_eca_event(ECA_EVENT.UI.open_loading_screen)
    G = {
      tiles = {},
      buildings = {},
      refs = require "Manager.Adapter.Eggy.Refs",
      lvs = {},
      role = {
        GameAPI.get_role(1),
        GameAPI.get_role(2),
