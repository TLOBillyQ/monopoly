...
local ItemEffects = require("Manager.GameManager.Item.ItemPostEffects")
...
local item_handlers = {
  [ITEM_IDS.remote_dice] = handle_remote_dice,
  [ITEM_IDS.roadblock] = handle_roadblock,
  [ITEM_IDS.monster] = handle_demolish,
  [ITEM_IDS.missile] = handle_demolish,
}
