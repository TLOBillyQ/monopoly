...
local BoardFactory = require("Manager.GameManager.System.BoardFactory")
local Player = require("Components.Player")
local PlayerVehicle = require("Manager.GameManager.System.PlayerVehicle")
local PlayerEffects = require("Manager.GameManager.System.PlayerEffects")
...
local turn_start = require("Manager.GameManager.Turn.TurnStart")
local turn_roll = require("Manager.GameManager.Turn.TurnRoll")
local turn_move = require("Manager.GameManager.Turn.TurnMove")
local turn_land = require("Manager.GameManager.Turn.TurnLand")
local turn_post = require("Manager.GameManager.Turn.TurnPost")
local turn_end = require("Manager.GameManager.Turn.TurnEnd")
...
local BankruptcyService = require("Manager.GameManager.System.BankruptcyService")
...
function CompositionRoot.assemble(opts, GameClass)
  ...
  ChoiceService.setup({
    inventory = require("Manager.GameManager.Item.ItemInventory"),
    executor = require("Manager.GameManager.Item.ItemExecutor"),
    strategy = require("Manager.GameManager.Item.ItemStrategy"),
    item_phase = require("Manager.GameManager.Item.ItemPhase"),
    effect = require("Manager.GameManager.Effect.Effect"),
    landing_effects = require("Config.LandingEffects"),
    land_choice_handler = require("Manager.GameManager.Choice.ChoiceHandlers.LandChoiceHandler"),
    market_choice_handler = require("Manager.GameManager.Choice.ChoiceHandlers.MarketChoiceHandler"),
    item_choice_handler = require("Manager.GameManager.Choice.ChoiceHandlers.ItemChoiceHandler"),
    optional_effect_handler = require("Manager.GameManager.Choice.ChoiceHandlers.OptionalEffectHandler"),
  })
  local phases = {
    start = turn_start,
    roll = turn_roll,
