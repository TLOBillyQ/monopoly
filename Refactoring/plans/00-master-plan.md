...
- [x] (2026-01-26 11:47) 完成 05-gameplay-items-chance.md - 玩法与道具/机会系统接入。
- [x] (2026-01-26 11:48) 完成 06-eca-bridge.md - ECA 触发器桥接。
- [x] (2026-01-26 11:48) 完成 07-visual-timeout-anim.md - 表现层等待、动画与超时补齐。
- [x] (2026-01-26 11:49) 完成 08-ai-behavior.md - AI 行为与自动操作完整性。
- [x] (2026-01-26 11:49) 完成 09-land-ownership.md - 地块购买与租金结算完整性。
- [x] (2026-01-26 11:50) 完成 10-land-upgrade.md - 地块加盖与建筑表现。
- [x] (2026-01-26 11:50) 完成 11-market-blackshop.md - 黑市与商城购买逻辑。
- [x] (2026-01-26 11:50) 完成 12-item-active-usage.md - 主动使用类道具卡。
- [ ] (2026-01-26 11:50) 汇总关键差异、验证结果与最终回顾。
...
**2026-01-26 完成所有 12 个子计划，重构版本基本完成：**

**第一阶段（01-04）：基础设施**
- 01：建立独立目录结构，复制 Eggy 工程骨架和 src/ 逻辑代码
- 02：验证配置同步，确保 design/ → src/config/ → Refactoring/src/config/ 数据流
- 03：确认入口流程完整，eggy_main → bootstrap → entry → eggy_runtime
- 04：集成 UIManager，删除过时 UINodes，统一 UI 管理

**第二阶段（05-08）：核心玩法**
- 05：验证 19 种道具 + 37 张机会卡配置完整，gameplay 模块齐全
- 06：确认 ECA 桥接就位，支持载具、UI 事件转发到 Eggy 触发器
- 07：确认表现层机制，move.lua 动画、超时自动确认、auto_runner
- 08：验证 AI 决策系统，agent.lua + item_strategy.lua + auto_all 模式

**第三阶段（09-12）：规则完整性**
- 09：验证地块系统，购买、租金、免租、强征、特殊地块
- 10：验证建筑系统，0-3 级升级、拆除、费用计算
- 11：验证黑市系统，三种货币、商品购买、AI 决策
- 12：验证主动道具，12 种 manual 道具、目标选择、效果执行

**关键成果：**
- Refactoring/ 目录具备完整独立运行能力
- 所有代码从仓库 src/ 同步，保持单一实现
- 19 种道具 + 37 张机会卡 + 完整回合流程
- UI 管理器统一、ECA 桥接完整、AI 行为完善
- 地块、建筑、黑市、道具规则齐全
