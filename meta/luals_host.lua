...
---@field create_obstacle_with_anim fun(_anim_type: integer, _u_key: ObstacleKey, _pos: Vector3, _duration: Fixed, _intensity: Fixed, _role: Role?, _rotation: Quaternion?, _scale: Vector3?): Obstacle
...
---@class LuaAPI
---@field ability_register_creation_handler fun(_ability_key: AbilityKey, _callback: function)
---@field ability_unregister_creation_handler fun(_ability_key: AbilityKey)
...
---@field modifier_register_creation_handler fun(_modifier_key: ModifierKey, _callback: function)
---@field modifier_unregister_creation_handler fun(_modifier_key: ModifierKey)
...
---@field set_unit_visible fun(_unit: Unit, _is_visible: boolean, _affect_children: boolean?)
