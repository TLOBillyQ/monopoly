...
local panel_presenter = require("visual.widget.panel_view")
local input_lock_policy = require("visual.control.input")
local role_control_lock_policy = require("visual.control.role_lock")
local modal_presenter = require("visual.widget.modal")
local runtime = require("visual.runtime")
local turn_effects = require("visual.widget.turn_effect")
local player_colors = require("visual.color")
...
function ui_view.init_ui_assets(state)
  ...
  local refs = require("cfg.RuntimeRefs")
  state.ui_refs = refs
