...
local tick_ui_sync = require("turn.sync")
local ui_event_state = require("visual.control.state")
...
local function _load_action_anim_player()
  ...
  _action_anim_player = require("visual.render.action_anim")
  return _action_anim_player
end
...
local function _default_reset_status_3d(state)
  local ui_status_3d = require("visual.render.status")
...
local function _default_on_bankruptcy_tiles_cleared(game, _, owned_tile_ids)
  ...
  local tile_renderer = require("visual.render.tile")
