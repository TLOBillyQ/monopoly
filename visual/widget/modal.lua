...
local modal_state = require("visual.control.modal")
local choice_renderer = require("visual.widget.choice_view")
local popup_renderer = require("visual.widget.popup")
local market_renderer = require("visual.widget.shop_modal")
