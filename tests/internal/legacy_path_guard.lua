local retired_path_parts = {
  ...
  { "src", "game", "flow", "turn", "turn_roll" },
  { "src", "game", "flow", "turn", "turn_move" },
  ...
  { "src", "game", "systems", "land", "land_actions" },
  { "src", "game", "systems", "land", "land_board_utils" },
  { "src", "game", "systems", "land", "land_choice_specs" },
  { "src", "game", "systems", "land", "land_events" },
  { "src", "game", "systems", "land", "land_pricing" },
  { "src", "game", "systems", "land", "land_rent_math" },
  { "src", "game", "systems", "land", "land_rent_resolver" },
  { "src", "game", "systems", "land", "land_rules" },
