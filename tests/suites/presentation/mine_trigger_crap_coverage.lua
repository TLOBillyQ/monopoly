...
local function _test_scheduled_mine_trigger_prefers_unit_position_and_defers_snap()
...
local function _test_mine_trigger_falls_back_to_tile_position_for_player_cue()
  local state = support.build_min_state()
  local player_calls = {}
  local tile_calls = 0
...
local function _test_mine_trigger_without_any_position_uses_tile_cue_and_normalizes_duration()
  local state = support.build_min_state()
  local steps = {}
...
local function _test_mine_trigger_normalizes_negative_duration_without_scheduler()
  local state = support.build_min_state()
...
return {
  name = "mine_trigger_crap_coverage",
  tests = {
    {
      name = "scheduled mine trigger prefers unit position and defers snap",
      run = _test_scheduled_mine_trigger_prefers_unit_position_and_defers_snap,
    },
    {
      name = "mine trigger falls back to tile position for player cue",
      run = _test_mine_trigger_falls_back_to_tile_position_for_player_cue,
    },
    {
      name = "mine trigger without any position uses tile cue and normalizes duration",
      run = _test_mine_trigger_without_any_position_uses_tile_cue_and_normalizes_duration,
    },
    {
      name = "mine trigger normalizes negative duration without scheduler",
      run = _test_mine_trigger_normalizes_negative_duration_without_scheduler,
    },
  },
}
