...
local function _test_black_market_roadblock_then_mine_skips_market_and_clears_mine()
  local g = _new_game()
  _set_ui_port(g, { wait_action_anim = true })
  g.last_turn = {}
  local player = g.players[1]
...
local function _test_black_market_angel_clears_mine_then_opens_market()
  local g = _new_game()
  local player = g.players[1]
  local idx, _ = _first_tile_by_type(g.board, "market")
  g:update_player_position(player, idx)
...
return {
  ...
  tests = {
    ...
    },
    {
      ...
      run = _test_black_market_mine_resolves_before_market_choice,
    },
    {
      name = "black_market_roadblock_then_mine_skips_market_and_clears_mine",
      run = _test_black_market_roadblock_then_mine_skips_market_and_clears_mine,
    },
    {
