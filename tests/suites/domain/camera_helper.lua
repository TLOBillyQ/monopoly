...
local function _test_camera_helper_follow_sets_target_role_and_returns_true()
  local helper = _new_helper()
...
return {
  ...
  tests = {
    ...
    {
      name = "camera_helper_follow_sets_target_role_and_returns_true",
      run = _test_camera_helper_follow_sets_target_role_and_returns_true,
    },
  },
}
