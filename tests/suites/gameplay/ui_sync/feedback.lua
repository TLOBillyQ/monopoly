...
return {
  ...
  tests = {
    ...
    { name = "_test_update_countdown_action_button_ext", run = _update_countdown_extended_tests[9] },
    ...
    { name = "_test_is_action_button_wait_active_normal_ext", run = _is_action_button_wait_active_extended_tests[10] },
    { name = "_test_is_action_button_wait_active_finished_ext", run = _is_action_button_wait_active_extended_tests[11] },
    ...
    { name = "_test_is_action_button_wait_active_pending_choice_more", run = _is_action_button_wait_active_more_tests[3] },
    ...
    { name = "_test_update_countdown_action_button_final", run = _update_countdown_final_tests[2] },
