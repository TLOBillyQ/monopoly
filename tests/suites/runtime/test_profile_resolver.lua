...
local function _test_profiles_cover_all_item_cards()
  local covered = {}
...
return {
  name = "runtime.test_profile_resolver",
  tests = {
    ...
    { name = "profiles_cover_all_item_cards", run = _test_profiles_cover_all_item_cards },
  },
}
