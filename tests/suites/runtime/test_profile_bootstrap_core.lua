...
return {
  name = "runtime.test_profile_bootstrap_core",
  tests = {
    ...
    { name = "profile_bootstrap_rejects_item_count_over_inventory_limit", run = _test_profile_bootstrap_rejects_item_count_over_inventory_limit },
    { name = "bankruptcy_applies_tile_override", run = _test_bankruptcy_applies_tile_override },
    { name = "upgrade_build_applies_bootstrap", run = _test_upgrade_build_applies_bootstrap },
    { name = "market_applies_player_position", run = _test_market_applies_player_position },
    { name = "market_preloads_remote_dice", run = _test_market_preloads_remote_dice },
  },
}
