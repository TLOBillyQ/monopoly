...
local function _test_tip_queue_uses_fifo_queue_without_override()
  local shown = {}
  local timers = {}
...
local function _test_tip_queue_dedupes_same_semantic_key_across_active_and_pending()
  local shown = {}
  local timers = {}
...
local function _test_tip_queue_only_blocks_inter_turn_for_blocking_tips()
  local timers = {}
...
local function _test_tip_queue_non_blocking_tip_never_gates_inter_turn()
  _with_queue_runtime(function()
    tip_queue.configure_runtime({
      presenter = function() end,
      scheduler = function()
...
local function _test_tip_queue_clear_cancels_stale_timeout_without_replaying_queue()
  local shown = {}
  local timers = {}
