...
local function test_set_tile_owner_without_ui_port_does_not_crash()
  local g = new_game()
  g.ui_port = nil
...
local function test_tile_owner_notifier_receives_owner_changes()
  local g = new_game()
  g.ui_port = nil
  local _, tile_ref = first_land_tile(g.board)
  local p1 = g.players[1]
...
local function test_dispatch_validator_accepts_ui_state_snapshot()
  local ui_state = {
    input_blocked = true,
...
local function test_stop_all_players_movement_clears_move_dir_and_stop_event()
  local g = new_game()
...
local function test_end_turn_stops_all_players_movement()
  local g = new_game()
  with_turn_flow(g)
  g.players[1].seat_id = 4001
  g.players[2].seat_id = nil
...
local function test_stop_all_players_movement_skips_invalid_role_without_error()
  local g = new_game()
  g.players[1].seat_id = 4001
...
local function test_set_player_seat_emits_exit_then_enter()
  local g = new_game()
  local p = g.players[1]
  p.seat_id = 4001
  local calls = {}
...
local function test_mine_destroy_vehicle_emits_exit_event()
  local g = new_game()
  local p = g.players[1]
  p.seat_id = 4001
  local exited = {}
...
local function test_vehicle_feature_disabled_ignores_seat_bonus()
  local g = new_game()
...
local function test_turn_move_anim_omits_vehicle_id_when_disabled()
  local g = new_game()
  local p = g:current_player()
  p.seat_id = 4001
  g.last_turn = {}
...
return {
  ...
  test_set_tile_owner_without_ui_port_does_not_crash,
  test_tile_owner_notifier_receives_owner_changes,
  test_dispatch_validator_accepts_ui_state_snapshot,
  test_stop_all_players_movement_clears_move_dir_and_stop_event,
  test_end_turn_stops_all_players_movement,
  test_stop_all_players_movement_skips_invalid_role_without_error,
  test_set_player_seat_emits_exit_then_enter,
  test_mine_destroy_vehicle_emits_exit_event,
  test_vehicle_feature_disabled_ignores_seat_bonus,
  test_turn_move_anim_omits_vehicle_id_when_disabled,
}
