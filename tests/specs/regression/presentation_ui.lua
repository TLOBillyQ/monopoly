...
local event_handlers = require("visual.event")
local paid_currency_bridge = require("game.commerce.paid_bridge")
local turn_dispatch = require("turn.dispatch")
local runtime_port = require("visual.runtime")
local ui_intent_dispatcher = require("visual.control.dispatch")
local market_view = require("visual.render.shop_view")
local market_layout = require("visual.shop_layout")
local ui_event_router = require("visual.control.router")
local ui_view = require("visual.view")
local ui_status_3d_layer = require("visual.render.status")
local action_anim = require("visual.render.action_anim")
local move_anim = require("visual.render.move_anim")
local role_control_lock_policy = require("visual.control.role_lock")
local ui_touch_policy = require("visual.control.touch")
...
local function _test_board_view_vehicle_resync_uses_set_position()
  local board_view = require("visual.render.board_view")
...
local function _test_ui_panel_clamps_negative_assets_to_zero()
  local ui_panel = require("visual.widget.panel")
...
local function _test_ui_view_render_by_role_slots_are_isolated()
  local main_view = require("visual.view")
...
local function _test_tick_skips_anim_when_no_anim()
  ...
  local main_view = require("visual.view")
  local ui_model = require("visual.model")
  local board_view_mod = require("visual.render.board_view")
