...
local visited_tile_ids = support.visited_tile_ids
local list_contains = support.list_contains
...
local function _test_chance_move_backward_queues_move_effect_anim()
  ...
  assert_eq(g.turn.action_anim.to_index, p.position, "move_effect to_index should match player position")
end
...
local function _test_chance_forced_move_queues_move_effect_anim()
  ...
  assert_eq(out.board_index, idx, "forced_move board_index should match destination")
  assert(g.turn.action_anim and g.turn.action_anim.kind == "move_effect", "forced_move should queue move_effect anim")
  assert_eq(g.turn.action_anim.to_index, idx, "forced_move anim to_index should match destination")
end
