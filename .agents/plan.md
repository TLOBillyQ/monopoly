...
- [x] (2026-03-05 18:52+08:00) 波次 0 / SA-1：已把 21 项反馈映射到现有 suite 断言，并新增/更新 `land/config_sanity/market/paid_currency` 定向用例。
...
- [ ] 波次 2B / SA-17：测试价开关化仍待与测试 profile 策略对齐（当前未污染正式 Generated 数据）。
