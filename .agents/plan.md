...
- **status**: Completed
- **log**: Added `runtime_state_seam` and `landing_visual_hold_seam`, rewired presentation/runtime consumers to import those seams instead of the state-access modules directly, and kept test patch points working by resolving the underlying state modules lazily through `package.loaded`. Verified with the grep allowlist and `lua tests/behavior.lua`.
- **files edited/created**: `src/ui/ctl/ports/runtime_state_seam.lua`, `src/ui/ctl/ports/landing_visual_hold_seam.lua`, `src/presentation/runtime/state_factory.lua`, `src/presentation/runtime/runtime_event_bridge.lua`, `src/ui/ctl/ports/common.lua`, `src/ui/ctl/ports/ui_sync_ports.lua`, `src/ui/ctl/ports/ui_sync/ui_model_sync.lua`, `src/ui/ctl/ports/ui_sync/choice_ui_state.lua`, `src/ui/ctl/local_actor_resolver.lua`, `src/ui/ctl/modal_controller.lua`, `src/ui/ctl/popup_controller.lua`, `src/ui/ctl/market_controller.lua`, `src/ui/ctl/item_slots.lua`, `src/ui/ctl/choice_screens/helpers.lua`, `src/ui/ctl/event_handlers.lua`, `src/ui/ctl/ports/anim_ports.lua`, `src/ui/stores/modal_state.lua`, `src/ui/pres/choice_slice.lua`, `src/ui/render/board.lua`, `src/ui/render/board/placement.lua`, `src/ui/render/market.lua`, `src/ui/render/market_controls.lua`, `src/ui/input/event_intents.lua`, `src/ui/input/canvas_route_market.lua`, `src/ui/input/canvas_route_item_slots.lua`, `src/ui/input/canvas_route_target_choice.lua`, `src/ui/input/canvas_route_remote_choice.lua`, `src/ui/input/dispatch_item_phase_ask.lua`, `src/ui/input/dispatch_pre_confirm.lua`.
