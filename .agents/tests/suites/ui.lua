...
local function _test_ui_view_render_by_role_slots_are_isolated()
  ...
  assert((not button_logs[1]) or button_logs[1]["托管按钮"] == nil, "role1 auto label should keep original")
  assert((not button_logs[2]) or button_logs[2]["托管按钮"] == nil, "role2 auto label should keep original")
