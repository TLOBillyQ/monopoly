...
1. 先确定日志路径，按以下优先级：
   ...
   - 平台默认目录：
     - `win`: `~/Desktop/dev/LuaSource_大富翁-发布/log.txt`
     - `mac`: `~/Documents/eggy/LuaSource_大富翁-发布/log.txt`
...
/debug
/debug win
/debug --target-path C:\Users\Lzx_8\Desktop\dev\LuaSource_大富翁-发布
/debug --log-path C:\Users\Lzx_8\Desktop\dev\LuaSource_大富翁-发布\log.txt
```
